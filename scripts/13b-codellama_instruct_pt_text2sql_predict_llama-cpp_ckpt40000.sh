...
export peft_name_or_path_subfolder=checkpoint-40000

export llama_cpp_model_path=quantized_models/tmnam20/13b-codellama_instruct_pt_text2sql/checkpoint-40000/ggml-model-q4_k_m.gguf
